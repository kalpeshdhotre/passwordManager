...
const navigation = [
   { name: "Add New Client", href: "#", current: false },
   { name: "Client List", href: "#", current: true },
   { name: "Client Data", href: "#", current: false },
                  ...
                  <div className="relative flex h-16 items-center justify-between">
                     ...
                     <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        <div className="flex flex-shrink-0 items-center">
                           <img className="h-8 w-auto" src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Password.svg/90px-Password.svg.png" alt="Your Company" />
                        </div>
